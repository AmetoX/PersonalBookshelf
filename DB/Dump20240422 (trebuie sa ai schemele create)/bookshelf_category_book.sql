...
CREATE TABLE `category_book` (
  ...
  KEY `book_id` (`book_id`),
  CONSTRAINT `category_book_ibfk_1` FOREIGN KEY (`categories_id`) REFERENCES `categories` (`id`),
  CONSTRAINT `category_book_ibfk_2` FOREIGN KEY (`book_id`) REFERENCES `books` (`id`)
